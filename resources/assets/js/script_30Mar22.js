				...
				breadcrumbsUrls.forEach(function (u, i) {
					...
					if (i !== breadcrumbsUrls.length - 1) 
					{
					   // name="Resources";
					        ...
					        url += '<a href="'+u+'"><span class="folderName" style="color:black">' + name[name.length-1] + '</span></a> <span class="arrow">→</span> ';
					   
					}
					else
					{
						url += '<span class="folderName" style="color:black">' + name[name.length-1] + '</span>';
					}
